  ...
  return (
    <>
      <SEO
        ...
        description="Replace paper menus with a beautiful QR code digital menu. Customers scan, order and pay from their phone. Built for restaurants, cafes and dhabas in Odisha. LogiSaar: +91 78150 14638"
        keywords="QR code menu Odisha, digital menu restaurant Bhubaneswar, QR menu system Cuttack, restaurant ordering system Odisha, contactless menu Odisha, LogiSaar"
